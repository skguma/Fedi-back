...
public class AnalysisService {
	...
	public List<Long> addAnalysis(Map<String, Double> dtos, String inputVector) {
		List<Long> analysisIds = new ArrayList<>();
		for (Map.Entry<String, Double> dto : dtos.entrySet()) {
			Image image = imageRepository.findById(Long.parseLong(dto.getKey()))
